        ...
        <>
            ...
            <div className="container border mb-4" key={blog?.id}>
                ...
                <div className="mx-auto px-8 py-4">
                    ...
                    <Link to={`/blog/${blog?.id}`} className='text-left text-lg font-bold'>{ReactHtmlParser(blog?.description.slice(0,20))}</Link>
                    ...
                    <div className="desc py-4 text-sm border-b">
                        <span>{ReactHtmlParser(blog?.description?.slice(0,150))}</span> 
