            ...
            <footer className="mt-8">
                <div className="text-sm max-w-[1240px] mx-auto">
                    <ul className='text-white flex flex-col md:flex-row'>
                        ...
                        <li className='my-2 md:my-0'><Link to={'/login'} className=' border-0 border-none md:border-r-2'>System</Link></li>
                        {authState.state&&
                        <li className='my-2 md:my-0'><a href={'/app/dashboard'} className=''>Dashboard</a></li>
                        }
                    </ul>
                </div>
