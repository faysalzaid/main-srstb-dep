    ...
    <header className="header_nav z-40 py-4 bg-white shadow-bottom dark:bg-gray-800">
      ...
      <div className="container flex items-center justify-between h-full px-6 mx-auto text-purple-600 dark:text-purple-300">
        ...
        <ul className="flex items-center flex-shrink-0 space-x-6">
          ...
          <li className="flex">
            <button
              className="rounded-md focus:outline-none focus:shadow-outline text-blue-500"
              onClick={toggleMode}
          ...
          {/* <!-- Notifications menu --> */}
          <Link to={'/'}><Button size="small" className="mt-1 custom-button" style={{background:'#256aeb'}} iconLeft={FiEye}>View Site</Button></Link>
              ...
              <Link to={"/app/chat"}>
                {newMessages > 0 && (
                  <StyledBadge badgeContent={newMessages} color="secondary">
                    <MdMailOutline color="action" style={{ fontSize: 21 }} className="text-blue-500"/>
                  </StyledBadge>
                )}
                {newMessages <= 0 && (
                  <MdMailOutline color="action" style={{ fontSize: 21 }} className="text-blue-500"/>
          ...
          <li className="relative flex">
            ...
            <button
              className="ml-4 rounded-full focus:shadow-outline text-blue-500 focus:outline-none text-xs px-0 py-2"
